...
public class Config {
 ...
 /*
    ...
    //public static final String urlGuardar = "http://192.168.187.109/mysqlcrud/guardar.php";                               //Guardar datos DB.
    public static final String urlGuardar = "http://192.168.187.109/sis21b/guardar.php";                               //Guardar datos DB.

    public static final String urlEliminar = "http://192.168.187.109/sis21b/eliminar.php";                             //Eliminar datos DB.
    public static final String urlActualizar = "http://192.168.187.109/sis21b/actualizar.php";                          //Actualizar datos DB.

    public static final String urlConsultaApiMySQLi = "http://192.168.187.109/sis21b/Api.php";                          //Ver todos los registros DB.
    public static final String urlConsultaApiPDO = "http://192.168.187.109/sis21b/buscarAll.php";                       //Ver todos los registros DB.

    public static final String urlConsultaCodigo = "http://192.168.187.109/sis21b/buscarArticulosCodigo.php";            //Busquedas por código.
    public static final String urlConsultaDescripcion = "http://192.168.187.109/sis21b/buscarArticulosDescripcion.php";  //Busquedas por descripción.
    public static final String urlConsultaAllArticulos = "http://192.168.187.109/sis21b/buscarArticulos.php";            //Devuelve todos los registros de la tabla MySQL.
 */
